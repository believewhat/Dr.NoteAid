...
# --model_name_or_path /data/home1/zhichao/pubmedgpt/instruction_tunning/tmp/mediqachat_medinsgpt_hcpt \
CUDA_VISIBLE_DEVICES=7 WANDB_MODE=offline python run_insft_mediqachat_sectionclass_prompt_predonly.py \
    ...
    --output_dir ./tmp/mediqachat_medinsgpt_hc_result_to_submit \
    --per_device_train_batch_size 1 --per_device_eval_batch_size 1 --gradient_accumulation_steps 4 \
    --num_train_epochs 10 --learning_rate 1.6e-06 --weight_decay 0.005 --warmup_ratio 0.1 --adam_beta1 0.9 --adam_beta2 0.95 --bf16=True \
    --predict_with_generate --generation_num_beams 2 \
    --run_name mediqachat_medinsgpt_hc_result_to_submit \
    --logging_steps 50 --eval_steps 250 --evaluation_strategy steps --save_steps 60000 --save_strategy steps 
mv ./tmp/mediqachat_medinsgpt_hc_result_to_submit/predict_outputs.json ./tmp/mediqachat_medinsgpt_hc_result_to_submit/test.json 
cp ./tmp/preprocessed_data/train.json ./tmp/mediqachat_medinsgpt_hc_result_to_submit/train.json 
...
CUDA_VISIBLE_DEVICES=7 WANDB_MODE=offline python run_insft_mediqachat_predonly.py \
    --seed=42 --tokenizer_name stanford-crfm/pubmed_gpt_tokenizer \
    --dataset_name medical_instruct_finetune --preprocessing_num_workers=4 \
    --model_name_or_path stanford-crfm/BioMedLM \
    --do_predict \
...
mv ./tmp/mediqachat_medinsgpt_ft_beamsearch_new_new/generated_all ./tmp/mediqachat_medinsgpt_hc_result_to_submit/generated_all
mv ./tmp/mediqachat_medinsgpt_ft_beamsearch_new_new/generated_predictions ./tmp/mediqachat_medinsgpt_hc_result_to_submit/generated_predictions
mv ./tmp/mediqachat_medinsgpt_ft_beamsearch_new_new/all_results.json ./tmp/mediqachat_medinsgpt_hc_result_to_submit/generated_predictions/all_results.json
rm -rf ./tmp/mediqachat_medinsgpt_ft_beamsearch_new_new

python postprocess_data.py ./tmp/mediqachat_medinsgpt_hc_result_to_submit/generated_predictions/generated_predictions.csv ./output/taskA_teamName_run1.csv
